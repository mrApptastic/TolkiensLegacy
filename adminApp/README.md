...
<ol>
    ...
    <li>Create a local MySQL db with the name 'tolkiendb'. User must be set to 'root' and have no password set (Otherwise, you will need to change the connection string manually...).</li>
